 ...
 *  - [buildAuthed]: agrega el header Authorization en cada request (uso normal).
 *  - [buildPlain]: sin header, usado únicamente para login/registro/refresh.
 * Mismo patrón, verbatim, que ya prueba
 * Deliverables/WearableApp/source/.../data/network/ApiClient.kt.
 */
object ApiClient {
